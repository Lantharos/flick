...
exports.RandomPlugin = exports.TimePlugin = exports.FilesPlugin = exports.WebPlugin = void 0;
...
exports.WebPlugin = {
    ...
    registerBuiltins(env, args) {
        // Can add helper functions here if needed
    },
    async execute(node, interpreter, env) {
    ...
    async onFileComplete(context) {
        ...
        const routes = new Map(); // key: "METHOD:path"
        ...
        const collectRoutes = (node, prefix = '') => {
            ...
            if (node.body && Array.isArray(node.body)) {
                node.body.forEach((child) => collectRoutes(child, prefix));
            }
